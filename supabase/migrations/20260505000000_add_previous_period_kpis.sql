-- Migration: Adiciona previous_unique_stores, previous_unique_devices e previous_period_days
-- aos KPIs da RPC get_overview_metrics para suportar comparativo em todos os 4 cards.
-- Quando NÃO há filtro de data: compara última semana (baseada na data máxima do banco) vs penúltima.
-- Quando HÁ filtro de data: compara período selecionado vs período equivalente anterior.
-- NÃO destrutiva: apenas substitui a função existente com campos adicionais.
